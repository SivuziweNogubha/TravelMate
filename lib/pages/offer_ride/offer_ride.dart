...
//
//   Future<void> _getCurrentLocation() async {
//     await _googleMapsService.getCurrentLocation();
...
//     return Stack(
//       children: [
//         _googleMapsService.currentPosition != null
//             ? GoogleMap(
//           initialCameraPosition: CameraPosition(
//             target: LatLng(
//               _googleMapsService.currentPosition!.latitude,
//               _googleMapsService.currentPosition!.longitude,
//             ),
//             zoom: 15,
//           ),
//           onMapCreated: _googleMapsService.onMapCreated,
//           mapType: MapType.normal,
//           myLocationEnabled: true,
//           myLocationButtonEnabled: true,
//           markers: {}, // Add markers if needed
//           // Optionally, add other properties such as onTap, polylines, etc.
//         )
//             : const Center(
//           child: CircularProgressIndicator(),
//         ),
